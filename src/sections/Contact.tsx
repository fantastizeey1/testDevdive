...
const Contact = () => {
  ...
  return (
    <div className=" relative">
      <Container className="flex flex-col lg:flex-row w-full items-start lg:items-center justify-center gap-12 lg:gap-20 px-6 sm:px-12 md:px-[107px] lg:px-20 py-12 sm:py-16 lg:py-24">
